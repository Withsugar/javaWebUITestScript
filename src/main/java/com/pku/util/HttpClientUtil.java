...
public class HttpClientUtil {
	 ...
	 * @return 远程主机响应正文
	 */
	public static String sendGetRequest(String reqURL, String decodeCharset, DefaultHttpClient httpClient){
	 ...
	 */
	public static String sendPostRequest(String reqURL, String sendData, boolean isEncoder, DefaultHttpClient httpClient){
		return sendPostRequest(reqURL, sendData, isEncoder, null, null, httpClient);
	}
	 ...
	 * @return 远程主机响应正文
	 */
	public static String sendPostRequest(String reqURL, String sendData, boolean isEncoder, String encodeCharset, String decodeCharset, DefaultHttpClient httpClient){
	 ...
	 * @return 远程主机响应正文
	 */
	public static String sendPostRequest(String reqURL, String sendData, boolean isEncoder, String encodeCharset, String decodeCharset,CookieStore cookieStore, DefaultHttpClient httpClient){
		String responseContent = null;
		//HttpClient httpClient = new DefaultHttpClient();
		//DefaultHttpClient httpClient = new DefaultHttpClient(new PoolingClientConnectionManager());
	 ...
	 * @return 远程主机响应正文
	 */
	public static String sendPostRequest(String reqURL, Map<String, String> params, String encodeCharset, String decodeCharset, DefaultHttpClient httpClient){
		String responseContent = null;
		//HttpClient httpClient = new DefaultHttpClient();
		//DefaultHttpClient httpClient = new DefaultHttpClient(new PoolingClientConnectionManager());
		HttpPost httpPost = new HttpPost(reqURL);
...
//			br.close();
	...
	/*public static void main(String[] args) {  
        String str = HttpClientUtil.sendPostRequest("http://10.100.139.18:8889/backCenter/project/changeStatus.htmls", "id=671&status=1", true);  
